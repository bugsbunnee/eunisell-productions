      ...
      <div className="grid grid-cols-1 lg:grid-cols-[500fr_860fr] gap-12 lg:gap-20 w-full">
        <div className="flex flex-col gap-10 items-start">
          ...
          {offices.map(({ name, address, phone, email }) => (
            <div key={name} className="flex flex-col gap-3 items-start bg-white border border-line rounded-2xl p-8 w-full shadow-[0px_1px_1px_rgba(0,0,0,0.05)]">
        ...
        <div className="relative h-100 lg:h-150 rounded-3xl overflow-hidden bg-line">
          ...
          <div className="absolute left-[45%] top-[60%] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
            <div className="absolute bg-secondary opacity-20 rounded-full size-10" />
