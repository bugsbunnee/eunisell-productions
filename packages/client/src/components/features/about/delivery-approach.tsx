  ...
  return (
    <section className="bg-surface flex flex-col gap-16 lg:gap-20 items-center px-9 md:px-16 lg:px-36 py-16 lg:py-35">
      ...
      <div className="relative max-w-300 w-full">
        <motion.div
          className="absolute hidden lg:block left-0 right-0 top-8 h-px bg-line origin-left"
          initial={{ scaleX: 0 }}
        ...
        <Stagger className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 w-full">
          {steps.map(({ number, icon, title, description }) => (
            <StaggerItem key={number} className="relative flex flex-col items-center gap-4 text-center">
