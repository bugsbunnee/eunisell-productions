...
const HseqSafety: React.FC = () => {
  return (
    <section className="bg-accent flex flex-col lg:flex-row items-center">
      ...
      <FadeIn className="flex flex-1 flex-col gap-4 items-start px-9 md:px-16 lg:px-25 py-16 lg:py-0 w-full">
        ...
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full pt-8">
