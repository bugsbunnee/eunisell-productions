...
const Cta: React.FC = () => {
  return (
    <section className="bg-accent flex flex-col gap-12 lg:gap-20 items-start overflow-hidden py-16 lg:py-35 w-full">
      <div className="flex flex-col gap-8 items-start px-9 md:px-16 lg:px-36 w-full">
      ...
      <div className="flex flex-col lg:flex-row items-start w-full">
        <div className="flex flex-1 items-start px-9 md:px-16 lg:pl-36 lg:pr-12 w-full">
          <img
            src={partnerImg}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-12 lg:gap-y-16 flex-1 px-9 md:px-16 lg:pr-36 lg:pl-0 pt-8 lg:pt-0 w-full">
