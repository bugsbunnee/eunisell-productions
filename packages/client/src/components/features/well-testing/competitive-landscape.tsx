      ...
      <div className="flex flex-col gap-16 w-full max-w-360 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {competitors.map(({ icon, title, description }) => (
            <div key={title} className="bg-white border border-line rounded-2xl drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex flex-col gap-5 items-start p-10">
              ...
              <p className="font-light text-navy-subtle text-base leading-[26px]">
