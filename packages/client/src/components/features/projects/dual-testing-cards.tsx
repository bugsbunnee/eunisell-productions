  ...
  return (
    <section className="bg-surface flex flex-col items-start px-9 md:px-16 lg:px-36 py-16 lg:py-35">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full">
        <div className="flex flex-col justify-between gap-10 items-start bg-white border border-line rounded-3xl shadow-[0px_1px_1px_rgba(0,0,0,0.05)] pt-12 px-12">
        ...
        <div className="flex flex-col justify-between gap-10 items-start bg-accent rounded-3xl shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] pt-12 px-12">
          <div className="flex flex-col gap-6 items-start pb-8 w-full">
            <div className="flex gap-4 items-center">
              <div className="bg-secondary h-1 w-12 shrink-0" />
